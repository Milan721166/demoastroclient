...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen font-sans bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="bg-gray-50 flex flex-col items-center justify-center text-center gap-10 py-16 sm:px-6 px-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="p-6 bg-gray-50 border-black border rounded-xl shadow-md hover:shadow-lg transition">
            ...
            <p className="text-sm text-gray-600">
              ...
              rem animi velit. Illum sunt et iure, recusandae corrupti voluptas,
              in architecto autem consequatur aliquam non odio maiores itaque
              neque perferendis?
            </p>
          </div>
      ...
      <section className="px-8 py-12 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-between items-start mb-12">
            ...
            <p className="text-sm text-gray-700 max-w-sm">
              Lorem ipsum dolor sit amet consectetur. Pellentesque nascetur sed
              tellus ut vehicula eu consectetur elit sit. Nulla erat nunc nisi
              dui sed cras semper vitae.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="space-y-10 relative mt-32">
              <div className="flex items-center space-x-6">
                <img src="land13.jpeg" alt="" className="h-40 w-40" />
                <div>
                  <h3 className="text-lg font-bold">ARIES</h3>
                  <p className="text-sm text-gray-600">
